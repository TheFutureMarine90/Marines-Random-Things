...
public class BlockAmethystOre extends Block{
	    ...
	    public BlockAmethystOre(String name) {
			super(Material.ROCK);
		...
		public Item getItemDropped(IBlockState state, Random random, int fortune){
	        ...
	        return this == ArmorModBlocks.amethyst_ore ? ArmorModItems.amethyst : Item.getItemFromBlock(this);
	    }
	    ...
	    public int getExpDrop(IBlockAccess world, BlockPos pos, int fortune){
	        ...
	        if (this.getItemDropped(state, random, fortune) != Item.getItemFromBlock(this)){
	            ...
	            if (this == ArmorModBlocks.amethyst_ore)
	            {
