...
public class BlockNetherCoalOre extends Block{
    ...
    public Item getItemDropped(IBlockState state, Random random, int fortune){
        ...
        return this == ArmorModBlocks.netherrack_coal_ore ? Items.COAL : Item.getItemFromBlock(this);
    }
    ...
    public int getExpDrop(IBlockAccess world, BlockPos pos, int fortune){
        ...
        if (this.getItemDropped(state, random, fortune) != Item.getItemFromBlock(this)){
            ...
            if (this == ArmorModBlocks.netherrack_coal_ore)
            {
                i = MathHelper.getRandomIntegerInRange(random, 0, 2);
            }
