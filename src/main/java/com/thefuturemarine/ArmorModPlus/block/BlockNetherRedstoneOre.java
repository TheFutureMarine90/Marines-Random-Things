...
public class BlockNetherRedstoneOre extends Block{
    ...
    public int quantityDropped(Random random) {
        ...
        return this == ArmorModBlocks.netherrack_redstone_ore ? 4 + random.nextInt(5) : 1;
    }

    public Item getItemDropped(IBlockState state, Random random, int fortune){

        return this == ArmorModBlocks.netherrack_redstone_ore ? Items.REDSTONE : Item.getItemFromBlock(this);
    }
    ...
    public int getExpDrop(IBlockAccess world, BlockPos pos, int fortune){
        ...
        if (this.getItemDropped(state, random, fortune) != Item.getItemFromBlock(this)){
            ...
            if (this == ArmorModBlocks.netherrack_redstone_ore)
            {
